...
/// The callback used by [ReorderableListViewShortPress] to move an item to a new
/// position in a list.
///
...
/// [ReorderableListViewShortPress] will need to account for this when inserting before
/// [newIndex].
///
...
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=3fB1mxOsqJE}
class ReorderableListViewShortPress extends StatefulWidget {

  /// Creates a reorderable list.
  ReorderableListViewShortPress({
    Key key,
    this.header,
  ...
  /// underlying list.
  ///
  /// This [ReorderableListViewShortPress] calls [onReorder] after a list child is dropped
  /// into a new position.
  final ReorderCallback onReorder;

  @override
  _ReorderableListViewShortPressState createState() => _ReorderableListViewShortPressState();
}
...
class _ReorderableListViewShortPressState extends State<ReorderableListViewShortPress> {
  // We use an inner overlay so that the dragging list item doesn't draw outside of the list itself.
  final GlobalKey _overlayKey = GlobalKey(debugLabel: '$ReorderableListViewShortPress overlay key');
